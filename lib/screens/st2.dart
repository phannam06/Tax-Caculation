...
class StatisticsScreen2 extends StatefulWidget {
  final String email;

  const StatisticsScreen2({required this.email});

  @override
  _StatisticsScreenState2 createState() => _StatisticsScreenState2();
}

class _StatisticsScreenState2 extends State<StatisticsScreen2>
  ...
  Future<void> loadIncomeInformation() async {
    try {
      ...
      DocumentReference docRef = FirebaseFirestore.instance
          ...
          .doc(widget.email); // Use user email to fetch data
